...
const iconStart = `<ion-icon name="play-outline"></ion-icon>`;
const iconPause = `const iconStart = `<ion-icon name="play-outline"></ion-icon>`;`
console.log(icon);
btnStart.addEventListener("click", function () {
  ...
  if (btnStart.innerHTML === iconStart) {
    btnStart.innerHTML = "pause-outline";
